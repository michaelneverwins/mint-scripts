...
These were tested on Linux Mint 22.3 and whatever version of Cinnamon it uses, and I assume out of laziness that they do not strongly depend on my particular system configuration and will generally do what their names imply on any Linux Mint 22.3 system with a Cinnamon desktop. Maybe the repository should be called `cinnamon-scripts` but I don't care enough to rename it.
